...
template <>
static constexpr auto rocblas_trsv_strided_batched<rocblas_float_complex> = rocblas_ctrsv_strided_batched;

template <>
static constexpr auto rocblas_trsv_strided_batched<rocblas_double_complex> = rocblas_ztrsv_strided_batched;

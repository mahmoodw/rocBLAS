    ...
    if(arg.unit_check || arg.norm_check)
    {
        ...
        for(int b = 0; b < batch_count; b++)
        {
            ...
            for(int i = 0; i < M; i++)
            {
                ...
                // if(hx[idx] != 0)
                // {
                    err_1 += rocblas_abs((hx[idx] - hx_or_b_1[idx]));
                    err_2 += rocblas_abs((hx[idx] - hx_or_b_2[idx]));
                    err_scal += hx[idx];
                // }
                // else
                // {
                //     err_1 += rocblas_abs(hx_or_b_1[idx]);
                //     err_2 += rocblas_abs(hx_or_b_2[idx]);
                // }
            }
        ...
        for(int b = 0; b < batch_count; b++)
        {
            ...
            for(int i = 0; i < M; i++)
            {
                ...
                // if(hb[idx] != 0)
                // {
                    res_1 += rocblas_abs((hx_or_b_1[idx] - hb[idx]));
                    res_2 += rocblas_abs((hx_or_b_2[idx] - hb[idx]));
                    res_scal += hb[idx];
                // }
                // else
                // {
                //     res_1 += rocblas_abs(hx_or_b_1[idx]);
                //     res_2 += rocblas_abs(hx_or_b_2[idx]);
                // }
            }

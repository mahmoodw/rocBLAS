...
namespace
{
    ...
    template <>
    constexpr char rocblas_trsv_strided_batched_name<rocblas_float_complex>[] = "rocblas_ctrsv_strided_batched";
    template <>
    constexpr char rocblas_trsv_strided_batched_name<rocblas_double_complex>[] = "rocblas_ztrsv_strided_batched";
